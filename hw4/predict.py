cuda_num = input("Input cuda number: ")
...
def parse_args():
  ...
  config = {
    ...
    "save_path": "/tmp2/b07902084/EEML/hw4/model-{}.ckpt".format(cuda_num),
    "batch_size": 32,
    "n_workers": 8,
    "valid_steps": 2000,
    "warmup_steps": 5000,
...
def main(
  ...
  torch.save(best_state_dict, "/tmp2/b07902084/EEML/hw4/model-{}.ckpt".format(best_accuracy))
  pbar.close()
...
def parse_args():
    ...
    config = {
        ...
        "output_path": "./output-{}.csv".format(best_accuracy),
    }
